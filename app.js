...
app.post('/clientsidedata', async (req, res) => {
  ...
  admin.auth().createUser(authuserobj)
...
app.get("/gflogin", function (req, res) {
    ...
    admin
      ...
      .then(() => {
        ...
        ref.orderByChild("Email").equalTo(req.cookies.Gfmail).on("value", (data)=> {
            ...
            if(!userDatabase) {
              ...
              res.render('pages/dashboard',{
                projects: projects,
                userobj: {Name:req.cookies.Gfmail, Role:'undefined', Email: 'anurag@gmail.com'}
              });
              return
            }
            ...
            res.render('pages/dashboard',{
              ...
              userobj: {Name:Object.values(userDatabase)[0].Name, Role:Object.values(userDatabase)[0].Role, Email:Object.values(userDatabase)[0].Email}
            });
        })   
      })
      .catch((error) => {
  ...
  app.post("/sessionLogin", (req, res) => {
    ...
    if(req.headers.gfuemail) {
      admin.auth().getUserByEmail(req.headers.gfuemail)
      .then((urecord)=>{
